...
const widthOFColumn = '150px'; // задайте ширину колонок
const gap = '7px'; // задайте расстояние между изображениями

export { accessKey, numberOfImages, columnCount, widthOFColumn, gap };
